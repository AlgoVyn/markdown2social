...
describe('CharacterCounter', () => {
  ...
  it('should show ok status for content well under limit', () => {
    const { container } = render(<CharacterCounter text="Short" platform="twitter" />);
  ...
  it('should show warning status near limit', () => {
    ...
    const { container } = render(<CharacterCounter text={text} platform="twitter" />);
  ...
  it('should render SVG progress ring', () => {
    const { container } = render(<CharacterCounter text="Test" platform="twitter" />);
