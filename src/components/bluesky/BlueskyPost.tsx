  ...
  return (
    <article className="bluesky-post" role="article" aria-label="Bluesky post preview">
      <header className="bluesky-header">
        ...
        <div className="bluesky-user-info">
          <span className="bluesky-display-name">Your Name</span>
          <span className="bluesky-handle">@handle.bsky.social</span>
        </div>
      </header>
      ...
      <footer className="bluesky-actions">
        <button className="bluesky-action-btn" aria-label="Reply" disabled>
          <svg
            viewBox="0 0 24 24"
            width="18"
            height="18"
        ...
        <button className="bluesky-action-btn" aria-label="Repost" disabled>
          <svg
            viewBox="0 0 24 24"
            width="18"
            height="18"
        ...
        <button className="bluesky-action-btn" aria-label="Like" disabled>
          <svg
            viewBox="0 0 24 24"
            width="18"
            height="18"
        ...
        <button className="bluesky-action-btn" aria-label="Share" disabled>
          <svg
            viewBox="0 0 24 24"
            width="18"
            height="18"
